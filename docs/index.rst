...
.. code-block:: xml
   ...
   <head>
	 ...
	 href="https://docs.pylonsproject.org/projects/pyramid/en/latest/"
...
<https://www.makotemplates.org/>`_ to use more advanced features.
...
<https://docs.makotemplates.org/en/latest/usage.html#using-templatelookup>`_ and accepts
...
<https://docs.makotemplates.org/en/latest/runtime.html#context-variables>`_).  By
...
Visit https://github.com/Pylons/pyramid_mako to download development or tagged
versions.
