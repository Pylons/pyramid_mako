# -*- coding: utf-8 -*-
#
# pyramid_mako documentation build configuration file
#
...
copyright = '2013-%s, Agendaless Consulting' % thisyear
...
htmlhelp_basename = 'pyramid_mako'
...
latex_documents = [
  ('index', 'pyramid_mako.tex', 'pyramid_mako Documentation',
